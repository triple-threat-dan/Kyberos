---
name: spell-crafter
description: Guide for creating/updating skills (skills) to extend kyberos with specialized knowledge, workflows, or tool integrations.
---

# Spell Crafter

Guide for creating effective skills (skills).

## About Skills

Skills are modular packages extending kyberos with specialized workflows, tools, and domain expertise. They transform a general-purpose agent into a specialized one.
...
### Concise is Key
Context is scarce. **Assume kyberos's agent is smart.** Only add missing context. Prefer concise examples over verbose explanations.
...
This will automatically create the spell in `./.kyberos/archive/my-new-spell`.
Do NOT create files manually in the current directory unless explicitly requested. Always use the standard Archive location.
