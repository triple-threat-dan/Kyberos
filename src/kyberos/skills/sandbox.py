"""
The Magic Circle: Safe Python Execution Sandbox for Kyberos.
...
logger = logging.getLogger("kyberos.sandbox")
...
class SandboxManager:
    ...
    def __init__(self, config: KyberosConfig):
        self.config = config
        self.sandbox_dir = Path.home() / ".kyberos" / ".kyberos_sandbox"
        self.temp_dir = Path.home() / ".kyberos" / "temp"
