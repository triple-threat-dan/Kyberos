"""
Base abstractions for platform adapters (Protocols) in Kyberos.
"""
...
class BaseProtocol(ABC):
    ...
    def __init__(self):
        self._message_handler: Optional[Callable[[ProtocolEvent], Awaitable[None]]] = None
    ...
    def on_message(self, callback: Callable[[ProtocolEvent], Awaitable[None]]) -> None:
    ...
    def get_tools_definition(self) -> str:
        """Return a markdown description of the tools provided by this protocol."""
        return ""

    def get_tool_names(self) -> List[str]:
        """Return a list of tool names handled by this protocol."""
        return []

    def get_tools_schema(self) -> List[Dict[str, Any]]:
        """Return a list of JSON schemas for the tools provided by this protocol."""
        return []

    async def execute_tool(self, tool_name: str, args: Dict[str, Any]) -> Any:
        """Execute a tool provided by this protocol."""
