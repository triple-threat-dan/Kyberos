...
logger = logging.getLogger("kyberos.protocol.telegram")

class TelegramProtocol(BaseProtocol):
    """Telegram adapter for the Kyberos Protocol system."""
    ...
    async def start(self) -> None:
        ...
        logger.info("Initializing Telegram Protocol...")
        ...
        self._started = True
        logger.info("Telegram Protocol started.")
    ...
    async def stop(self) -> None:
        ...
        logger.info("Stopping Telegram Protocol...")
        if self.application.updater:
        ...
        self._started = False
        logger.info("Telegram Protocol stopped.")
    ...
    async def send_message(self, target_id: str, content: str) -> None:
        ...
        if not self._started or not self.application:
            logger.error("Cannot send message: Telegram Protocol not started.")
            return
