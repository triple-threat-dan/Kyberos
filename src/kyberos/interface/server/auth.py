"""
Authentication middleware for the Kyberos API.
...
async def verify_token(
    ...
    """
    config: KyberosConfig = request.app.state.config
    ...
    # Lazy Reload: Check if token was updated on disk (e.g. via 'kyberos token new')
    from kyberos.core.config import ConfigLoader
    try:
