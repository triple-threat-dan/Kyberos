...
logger = logging.getLogger("kyberos.memory.chroma")
...
class ChromaStore(VectorStore):
    ...
    def __init__(self, collection_name: str = "kyberosmemory", persistence_path: Optional[Path] = None):
        ...
        self.persistence_path = persistence_path or (KYBEROS_ROOT / "chroma_db")
