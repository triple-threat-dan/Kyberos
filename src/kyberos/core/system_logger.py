"""
System-wide structured logging for Kyberos.
...
class SystemLogger:
    ...
    def __init__(self, config: KyberosConfig):
        self.config = config
        self.logger = logging.getLogger("kyberos.system")
    ...
    @classmethod
    def get_instance(cls, config: Optional[KyberosConfig] = None) -> 'SystemLogger':
        """Singleton accessor."""
