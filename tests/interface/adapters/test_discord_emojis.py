...
def test_emoji_fixing_logic():
    ...
    fixed3 = DiscordProtocol._chunk_message(text3)[0]
    assert fixed3 == "Already fine <a:cathi:1478099851047862436>"

    # Multiple emojis
    text4 = "a:emoji1:123 and :emoji2:456"
    fixed4 = DiscordProtocol._chunk_message(text4)[0]
    ...
    fixed5 = DiscordProtocol._chunk_message(text5)[0]
